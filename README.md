...
There isn't a single word that describes `this` well, so I just think of it as a special variable that is different depending on the situation. And those different situations are captured below.
